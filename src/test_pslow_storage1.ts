...
console.log(`proxySlow.wasm: ${proxyWasm}`);
...
const readAgeResponse1b = await readSc(
  client,
  storageScAddr,
  'getAge1',
  new Args(),
...
const ageFromGetAge1b = new Args(readAgeResponse1b.returnValue).nextU32();
console.log(`ageFromGetAge1b: ${ageFromGetAge1b}`);
assert.equal(ageFromGetAge1, ageFromGetAge1b);
// const opId = await callSc(client, storageScAddr, "getAge1", new Args(), MAX_GAS_EXECUTE_SC, 0n);
