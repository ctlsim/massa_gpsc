...
let storageWasm = path.join(__dirname, 'build', 'storage2.wasm');
...
// console.log(`proxyRead age1() 2`);
// const readAgeResponse1_2 = await proxyRead(client, proxyCallerAddr, "getAge1",
//     new Args());
// const ageFromGetAge1_2 = new Args(readAgeResponse1_2.returnValue).nextU32();
// console.log(`ageFromGetAge1_2: ${ageFromGetAge1_2}`);

// console.log(`readSC age1() on ${storageScAddr}`);
// const readAgeResponse1_3 = await readSc(client, storageScAddr, "getAge1",
//     new Args(), MAX_GAS_EXECUTE_SC);
// const ageFromGetAge1_3 = new Args(readAgeResponse1_3.returnValue).nextU32();
// console.log(`ageFromGetAge1_3: ${ageFromGetAge1_3}`);
// assert.equal(ageFromGetAge1, ageFromGetAge1_3);
const opId = await callSc(
  client,
  storageScAddr,
  'getAge1',
  new Args(),
...
let [opSt, evts] = await waitForEvents(client, opId, true);
console.log(`evts:`);
console.log(evts);
console.log(opSt);
